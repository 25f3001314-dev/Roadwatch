...
import com.roadwatch.backend.security.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    @Value("${roadwatch.cors.allowed-origins}")
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/auth/citizen-login").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/complaints/map").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/complaints/*").permitAll()
